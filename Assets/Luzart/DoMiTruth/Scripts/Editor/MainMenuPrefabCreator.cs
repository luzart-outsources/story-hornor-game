    ...
    public static class DoMiTruthOneClickSetup
    {
        ...
        public static void OneClickSetupAll()
        {
            ...
            EditorUtility.DisplayDialog(
                ...
                "Tạo BriefingCharacterSO (Create > DoMiTruth > Briefing Character)\n" +
                "rồi kéo vào GameConfig.briefingCharacters.",
                "OK");
        }
        ...
        private static void SetupGameConfig(List<string> log)
        {
            ...
            log?.Add("ℹ Tạo BriefingCharacterSO cho mỗi NPC (DoMiTruth/Briefing Character) rồi kéo vào GameConfig.briefingCharacters");
        ...
        private static GameObject CreateBriefingPrefab_Internal(List<string> log)
        {
            ...
            // ── NPC Full Body (left 40%) + CanvasGroup for highlight ──
            ...
            // ── NPC Label (top center, above case board) ──
            ...
            // ── Case Board (center-right, text NPC trái hiện ở đây) ──
            ...
            // ── Dialogue Box (bottom right, text NPC phải hiện ở đây) ──
            var dlgBox = MakeUI("DialogueBox", root.transform);
            var dbRect = dlgBox.GetComponent<RectTransform>();
            dbRect.anchorMin = new Vector2(0.3f, 0f); dbRect.anchorMax = new Vector2(1f, 0.28f);
            dbRect.offsetMin = new Vector2(20f, 15f); dbRect.offsetMax = new Vector2(-20f, 0f);
            dlgBox.AddComponent<Image>().color = C_BRIEF_DLG_BG;

            // Portrait (right side of dialogue box)
            ...
            nameTMP.text = ""; nameTMP.fontSize = 20f; nameTMP.fontStyle = FontStyles.Bold;
            ...
            dtRect.anchorMin = Vector2.zero; dtRect.anchorMax = new Vector2(0.82f, 0.75f);
            ...
            // Next button (bottom right, before portrait)
            ...
            so.FindProperty("dialogueBoxRoot").objectReferenceValue = dlgBox;
